CREATE TABLE cidade (
    cid_id INT PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
    cid_nome VARCHAR(200) NOT NULL,
    cid_uf VARCHAR(2) NOT NULL
);

CREATE TABLE endereco (
    end_id INT PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE pessoa (
    pes_id INT PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE unidade (
    unid_id INT PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE foto_pessoa (
    fp_id INT PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
    pes_id INT NOT NULL,
